...
#GPIO.output(19,GPIO.HIGH)	# B
#GPIO.output(8,GPIO.HIGH)	# C
#GPIO.output(10,GPIO.HIGH)	# D
#time.sleep(1)
while True:
...
#Tah_LCD.testing()
#time.sleep(1)
#Tah_LCD.lcd_byte(LCD_LINE_2, LCD_CMD)
#Tah_LCD.lcd_string("Vikas")
#time.sleep(1)
#while True:
#	value = GPIO.input(11)
#	if value:
